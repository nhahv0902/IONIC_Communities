...
.controller('MainCtrl', function ($ionicHistory, $rootScope, $scope, Data, $localStorage) {
	...
	if($localStorage.user.phone_number) {
		...
		//update online
		Data.getMembers($localStorage.user.phone_number)
			.then(function (data) {
...
.controller('ActivitiesCtrl', function ($rootScope, $scope, Data, $localStorage, $ionicActionSheet, $ionicHistory) {
				...
				buttonClicked: function (index) {
					...
					if(index == 0) {
						...
						$cordovaSocialSharing
							.shareViaEmail("", "", "nhahv0902@gmail.com", null, null, null)
...
.controller('AccountCtrl', function ($scope, $state, $ionicActionSheet, $rootScope, $ionicModal, $ionicPopup, $localStorage, Data, $auth, $cordovaCamera) {
